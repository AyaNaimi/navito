...
export default function PriceEstimator() {
  ...
  return (
    <div className="size-full bg-white/75 backdrop-blur-sm flex flex-col">
      ...
      <div className="flex-1 overflow-auto px-4 py-5 sm:px-6 sm:py-6 space-y-4">
        ...
        {!image ? (
          <>
            ...
            <button
              ...
              className="w-full rounded-2xl bg-gradient-to-br from-orange-500 to-orange-600 flex flex-col items-center justify-center gap-3 px-6 py-10 text-white shadow-lg min-h-[240px] max-h-[360px] md:min-h-[280px] md:max-h-[420px]"
            >
              <Camera className="h-10 w-10 md:h-12 md:w-12" />
              <span className="text-sm font-bold uppercase tracking-wider md:text-base">Prends une Photo</span>
            </button>
