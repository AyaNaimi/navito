...
export default function Transport() {
  ...
  return (
    <div className="size-full flex flex-col overflow-x-hidden bg-gradient-to-b from-[#0D9488]/5 via-white to-white with-bottom-nav">
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden">
        <Tabs defaultValue="drivers" className="w-full">
          <div className="sticky top-0 z-30 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/80 border-b border-gray-100">
            <div className="mx-auto w-full max-w-5xl px-4 py-3">
              <TabsList className="grid h-auto w-full grid-cols-3 items-stretch rounded-2xl border border-gray-200 bg-white p-1.5 shadow-sm">
            <TabsTrigger
              value="drivers"
                  className="h-14 rounded-xl text-xs font-semibold text-slate-600 hover:text-slate-900 data-[state=active]:bg-[#0D9488]/10 data-[state=active]:text-[#0D9488] data-[state=active]:shadow-[0_10px_25px_-18px_rgba(13,148,136,0.55)]"
            >
                  <span className="flex h-full w-full flex-col items-center justify-center gap-1 leading-none">
          ...
          <TabsContent value="drivers" className="space-y-6 px-4 pb-8 pt-5">
              ...
              <div className="space-y-4">
                {availableDrivers.map((driver, index) => (
                  <motion.div
                    ...
                    className="w-full rounded-2xl border-2 border-gray-100 bg-white p-5 transition-all duration-200 hover:border-[#0D9488]/50 hover:shadow-lg"
                  >
          ...
          <TabsContent value="guide" className="space-y-4 px-4 pb-8 pt-5">
            <div className="mx-auto w-full max-w-5xl">
            {isLoadingFares ? (
              <motion.div 
                initial={{ opacity: 0 }}
          ...
          <TabsContent value="simulator" className="px-4 pb-8 pt-5">
            <div className="mx-auto w-full max-w-5xl">
            <motion.div 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
