  ...
  return (
    <div className="size-full bg-white flex flex-col">
      ...
      <div className="flex-1 overflow-auto px-6 py-6 space-y-6">
        {/* Booking Details */}
        <div>
          <h2 className="text-lg font-bold text-gray-900 mb-4">{t('checkout.bookingDetails', 'Booking Details')}</h2>
          <div className="bg-gray-50 p-4 rounded-xl space-y-3">
            <div>
              <p className="text-sm text-gray-600">{t('checkout.experience', 'Experience')}</p>
              <p className="font-semibold text-gray-900">{item.name}</p>
            </div>
            <div>
              <p className="text-sm text-gray-600">{t('checkout.location', 'Location')}</p>
        ...
        <div className="space-y-2">
          <Label htmlFor="date">{t('checkout.selectDate', 'Select Date')}</Label>
        ...
        {/* Travelers */}
        <div className="space-y-2">
          <Label>{t('checkout.travelers', 'Number of Travelers')}</Label>
        ...
        {/* Contact Details */}
        <div>
          <h2 className="text-lg font-bold text-gray-900 mb-4">{t('checkout.contactDetails', 'Contact Details')}</h2>
        ...
        {/* Promo Code */}
        <div className="space-y-2">
          <Label htmlFor="promo">{t('checkout.promoCode', 'Promo Code (Optional)')}</Label>
        ...
        <div className="bg-gray-50 p-4 rounded-xl space-y-3">
          <div className="flex items-center justify-between">
            <span className="text-gray-700">{t('checkout.pricePerPerson', 'Price per person')}</span>
            <span className="font-semibold">{pricePerPerson} MAD</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-gray-700">{t('checkout.travelersCount', 'Travelers')}</span>
        ...
        <div className="bg-green-50 p-4 rounded-xl border border-green-200">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-semibold text-green-900 mb-1">{t('checkout.freeCancellation', 'Free cancellation')}</p>
              <p className="text-sm text-green-700">{t('checkout.freeCancellationDesc', 'Cancel up to 24 hours before your experience starts for a full refund.')}</p>
            </div>
          </div>
        </div>
      </div>
