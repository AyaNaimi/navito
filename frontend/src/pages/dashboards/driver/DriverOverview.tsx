import { CalendarDays, CarFront, CheckCircle2, MapPin, MessageSquare, Phone, ShieldCheck, UserRound } from "lucide-react";
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-4 text-sm font-medium text-slate-600">
                      ...
                      <span className="inline-flex items-center gap-2">
                        ...
                        {request.tourist?.phone ?? "Telephone non renseigne"}
                      </span>
                    </div>
